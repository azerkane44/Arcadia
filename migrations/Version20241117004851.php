 ...
 */
final class Version20241117004851 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal_images (animal_id INT NOT NULL, image_id INT NOT NULL, INDEX IDX_5AEE7BB68E962C16 (animal_id), INDEX IDX_5AEE7BB63DA5256D (image_id), PRIMARY KEY(animal_id, image_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE habitat_images (habitat_id INT NOT NULL, image_id INT NOT NULL, INDEX IDX_4A4A18D1AFFE2D26 (habitat_id), INDEX IDX_4A4A18D13DA5256D (image_id), PRIMARY KEY(habitat_id, image_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
